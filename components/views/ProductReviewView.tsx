    ...
    <div className="space-y-8">
      ...
      <div className={`bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm transition-opacity duration-500 ${step3Disabled ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}>
        ...
        <div className="flex gap-4 mb-4">
         ...
         <div className="text-xs text-neutral-500 dark:text-neutral-400 mb-6 p-3 bg-neutral-100 dark:bg-neutral-800/50 rounded-md space-y-1 text-center">
            <p>This process can take several minutes. You can also generate videos one by one.</p>
            <p>Please note: The voiceover language may be inconsistent. If you're not satisfied, you can regenerate the video individually using the 'Create Video' button on each scene.</p>
         </div>
